...
function phase:update(dt)
  ...
  elseif game.phase == 1 then
    ...
    if phase.timer < 0 then
      ...
      talkies.say("ERROR 0x00010F2C : NAME NOT FOUND", "Oh I see ... So your a player then!! \n Maybe they could help me... \n Sorry err uhh I see your name is listed in the data files as NAMEHERE?",{talkSound=blop,typedNotTalked=false,textSpeed="slow"})
      --insert get name function
      talkies.say("ERROR 0x00010F2C : NAME NOT FOUND", "Well it is oh so great to meet you NAMEHERE. I think your just the person I need.", { talkSound=blop,typedNotTalked=false,textSpeed="slow"})
