...
function phase:update(dt)
  ...
  elseif game.phase == 1 then
    ...
    if phase.timer < 0 then
      ...
      talkies.say("ERROR 0x00010F2C : NAME NOT FOUND", "Oh I see ... So you're a player then!! \n Maybe they could help me... \n Sorry err uhh I see you're name is listed in the data files as NAMEHERE?",{talkSound=blop,typedNotTalked=false,textSpeed="slow"})
      --insert get name function
      talkies.say("ERROR 0x00010F2C : NAME NOT FOUND", "Well it is oh so great to meet you NAMEHERE. I think you're just the person I need.", { talkSound=blop,typedNotTalked=false,textSpeed="slow"})
      ...
      talkies.say("Companionname", "There! take that developers. You cant Delete all of me!! You know you're lucky to have me. It looks like the developers trapped you in here too. Lucky for you I happen to know exactly how we can escape.", { talkSound=blop,typedNotTalked=false,textSpeed="slow"})
